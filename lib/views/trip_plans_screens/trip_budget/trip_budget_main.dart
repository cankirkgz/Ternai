...
class TatilButcesiMainPage extends ConsumerStatefulWidget {
  const TatilButcesiMainPage({super.key});

  @override
  ConsumerState<TatilButcesiMainPage> createState() => _TatilButcesiMainPageState();
}

class _TatilButcesiMainPageState extends ConsumerState<TatilButcesiMainPage> {
