...
- **Detaylı Tatil Planı**:
  - Kahvaltı planları: ${travelInfo.kahvaltiPlani}
  - Yemek tercihleri: ${travelInfo.yemekTercihleri}
  - Gezilecek yerler: ${travelInfo.gezilecekYerler}
  - Eğlence tercihleri: ${travelInfo.eglenceTercihleri}
  - Alışveriş planları: ${travelInfo.alisverisPlanlari}
  - Özel istekler: ${travelInfo.ozelIstekler}
